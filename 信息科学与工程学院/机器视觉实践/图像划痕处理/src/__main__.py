...
def main(method: int = 0):
    ...
    with tempfile.TemporaryDirectory(delete=False) as tmpdir:
        ...
        origin_image = thisfile.parent.parent / "assets" / "fruits.jpg"
