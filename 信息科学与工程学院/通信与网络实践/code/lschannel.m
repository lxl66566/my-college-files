function [slot0_ls,slot1_ls] = lschannel(fredata,rbnum,rbstart,subframeno,cellid,deltass,ndmrs1,cyc_shift)
...
printlschannelflag = 1; % 打印信道估计导频母码
   ...
   slotno = subframeno*2;
   [rs_slot1,rs_local_slot1] = pusch_rs_gen(rbnum,0,0,slotno,cellid,deltass,ndmrs1,cyc_shift,symbol_index_slot0);
   [rs_slot2,rs_local_slot2] = pusch_rs_gen(rbnum,0,0,slotno+1,cellid,deltass,ndmrs1,cyc_shift,symbol_index_slot1);
   scnum = 12*rbnum;
