function outequfredata = TDLTE_equal2ant(freqdata,freqdataant1,slot0lschannel,slot0lschannelant1,slot1lschannel,slot1lschannelant1,numsym,rbnum,rbstart,cptype)
% 双天线接收时 信道均衡
start =1;
scnum = 12*rbnum;
